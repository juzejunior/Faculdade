...
void MainWindow::imprimirArquivo(){
    fprintf(dictionaryInput,"%d %d %c\n", dictionary->value, dictionary->prefix, (char)dictionary->character);
}

// destroy the whole dictionary down to NULL
void MainWindow::dictionaryDestroy() {
    fprintf(dictionaryInput,"Resultado do Dicionario Criado\n");
